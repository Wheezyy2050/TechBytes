    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="max-w-2xl space-y-6">
        <div>
          ...
          <input type="text" required className="w-full bg-[#111] border border-[#1e1e1e] rounded p-3 text-sm focus:outline-none focus:border-[#e8ff47]" value={form.title} onChange={handleTitleChange} />
        </div>
        <div>
